...
global.owner = process.env.OWNER_NUMBER  || '94 71 341 6482' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=eFdHVSBR#b0KnxRkS_f-7gv5hob6WRelISAhWyhQg35NN-nN_Byk' ,
