...
global.owner = process.env.OWNER_NUMBER  || '+94720571302' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=2QkGFJxA#Z76QdXTOhf0CmI_ryMpEJyviRyrTKRG-zTAEbrw8iOQ' ,
